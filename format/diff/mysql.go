...
func (b *MysqlQueryBuilder) ToSQL(change interface{}) ([]string, error) {
	...
	case *UpdateUniqueConstraint:
		return b.toUpdateUniqueConstraintSQL(change.(*UpdateUniqueConstraint))
...
func (b *MysqlQueryBuilder) toCreateTableSQL(change *CreateTable) ([]string, error) {
	buf := new(bytes.Buffer)
	if err := b.mysqlExporter.ExportTable(buf, change.Table); err != nil {
		return nil, err
	}
...
func (b *MysqlQueryBuilder) toDropTableSQL(change *DropTable) ([]string, error) {
	return []string{
		fmt.Sprintf("DROP TABLE %s;", change.Table.Name),
	}, nil
}

func (b *MysqlQueryBuilder) toRenameTableSQL(change *RenameTable) ([]string, error) {
	return []string{
		fmt.Sprintf("RENAME TABLE %s TO %s;", change.OldTable.Name, change.NewTable.Name),
	}, nil
}

func (b *MysqlQueryBuilder) toUpdatePrimaryKeySQL(change *UpdatePrimaryKey) ([]string, error) {
	table := change.NewTable
...
func (b *MysqlQueryBuilder) toUpdateUniqueConstraintSQL(change *UpdateUniqueConstraint) ([]string, error) {
	// TODO
	return nil, nil
}

func (b *MysqlQueryBuilder) toSetTableCommentSQL(change *SetTableComment) ([]string, error) {
	// TODO
	return nil, nil
}

func (b *MysqlQueryBuilder) toAddColumnSQL(change *AddColumn) ([]string, error) {
...
func (b *MysqlQueryBuilder) toDropColumnSQL(change *DropColumn) ([]string, error) {
	// TODO
	return nil, nil
}

func (b *MysqlQueryBuilder) toSetColumnCommentSQL(change *SetColumnComment) ([]string, error) {
	// TODO
	return nil, nil
}

func (b *MysqlQueryBuilder) toChangeColumnTypeSQL(change *ChangeColumnType) ([]string, error) {
	// TODO
	return nil, nil
}

func (b *MysqlQueryBuilder) toRenameColumnSQL(change *RenameColumn) ([]string, error) {
	// TODO
	return nil, nil
}

func (b *MysqlQueryBuilder) toSetNotNullConstraintSQL(change *SetNotNullConstraint) ([]string, error) {
	tableName := change.Table.Name
	column := change.Column
	columnType := b.mysqlExporter.ToMysqlColumnType(column)
...
func (b *MysqlQueryBuilder) toSetAutoIncrementSQL(change *SetAutoIncrement) ([]string, error) {
	tableName := change.Table.Name
	column := change.Column
	...
	var sql string
	if change.Column.AutoIncremental {
...
func (b *MysqlQueryBuilder) toSetDefaultValueSQL(change *SetDefaultValue) ([]string, error) {
	// TODO
	return nil, nil
}
